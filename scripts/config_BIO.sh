...
export TRAIN_FILE="${JAMR_HOME}/data/bio-amr-0.8/amr/amr-release-training-bio.txt"
export DEV_FILE="${JAMR_HOME}/data/bio-amr-0.8/amr/amr-release-dev-bio.txt"
export TEST_FILE="${JAMR_HOME}/data/bio-amr-0.8/amr/amr-release-test-bio.txt"

export MODEL_DIR="${JAMR_HOME}/models/BIO"  # ideally keep this the same as the config_SOMETHING.sh
