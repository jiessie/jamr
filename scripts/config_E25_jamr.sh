...
export TRAIN_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/training/jamr/training.txt"
export DEV_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/dev/jamr/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/test/jamr/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/jamr/E25_jamr"  # ideally keep this the same as the config_SOMETHING.sh
