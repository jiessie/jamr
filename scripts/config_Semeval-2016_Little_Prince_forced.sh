...
export TRAIN_FILE="${JAMR_HOME}/data/little-prince-1.6/forced/amr-bank-struct-v1.6-training.txt"
export DEV_FILE="${JAMR_HOME}/data/little-prince-1.6/forced/amr-bank-struct-v1.6-dev.txt"
export TEST_FILE="${JAMR_HOME}/data/little-prince-1.6/forced/amr-bank-struct-v1.6-test.txt"

export MODEL_DIR="${JAMR_HOME}/models/forced/Semeval-2016_Little_Prince_forced"  # ideally keep this the same as the config_SOMETHING.sh
...
"
# --stage2-labelset ${JAMR_HOME}/resources/outerRelLabelset-r5
#--output-format AMR,nodes,edges,root
#--stage1-wiki
