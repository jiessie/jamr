...
export TRAIN_FILE="${JAMR_HOME}/data/e25_reified/data/amrs/split/training/training.txt"
export DEV_FILE="${JAMR_HOME}/data/e25_reified/data/amrs/split/dev/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/e25_reified/data/amrs/split/test/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/jamr/E25_reified_jamr"  # ideally keep this the same as the config_SOMETHING.sh
...
export PARSER_OPTIONS="
    ...
    --stage2-labelset ${JAMR_HOME}/resources/labelset-reified
