...
export TRAIN_FILE="${JAMR_HOME}/data/e25_reified/data/amrs/split/training/jamr/training.txt"
export DEV_FILE="${JAMR_HOME}/data/e25_reified/data/amrs/split/dev/jamr/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/e25_reified/data/amrs/split/test/jamr/test.txt"
