...
export TRAIN_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/training/uamr/training.txt"
export DEV_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/dev/uamr/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/test/uamr/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/uamr/E25_uamr"  # ideally keep this the same as the config_SOMETHING.sh
