...
export TRAIN_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/training/isi/training.txt"
export DEV_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/dev/isi/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/test/isi/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/isi/E25_isi"  # ideally keep this the same as the config_SOMETHING.sh
