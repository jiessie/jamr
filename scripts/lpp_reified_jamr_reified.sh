...
export TRAIN_FILE="${JAMR_HOME}/data/little-prince-1.6_reified/amr-bank-struct-v1.6-training.txt"
export DEV_FILE="${JAMR_HOME}/data/little-prince-1.6_reified/amr-bank-struct-v1.6-dev.txt"
export TEST_FILE="${JAMR_HOME}/data/little-prince-1.6_reified/amr-bank-struct-v1.6-test.txt"
