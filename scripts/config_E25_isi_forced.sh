...
export TRAIN_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/training/isi_forced/training.txt"
export DEV_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/dev/isi_forced/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/test/isi_forced/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/isi/E25_isi_forced"  # ideally keep this the same as the config_SOMETHING.sh
