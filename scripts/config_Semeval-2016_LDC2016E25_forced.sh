...
export TRAIN_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/training/forced/training.txt"
export DEV_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/dev/forced/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/test/forced/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/forced/Semeval-2016_LDC2016E25_forced"  # ideally keep this the same as the config_SOMETHING.sh
