...
export TRAIN_FILE="${JAMR_HOME}/data/little-prince-1.6_reified/isi_force/amr-bank-struct-v1.6-training.txt"
export DEV_FILE="${JAMR_HOME}/data/little-prince-1.6_reified/isi_force/amr-bank-struct-v1.6-dev.txt"
export TEST_FILE="${JAMR_HOME}/data/little-prince-1.6_reified/isi_force/amr-bank-struct-v1.6-test.txt"

export MODEL_DIR="${JAMR_HOME}/models/isi/lpp_reified_isi_force"  # ideally keep this the same as the config_SOMETHING.sh
