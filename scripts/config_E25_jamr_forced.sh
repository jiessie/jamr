...
export TRAIN_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/training/jamr_forced/training.txt"
export DEV_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/dev/jamr_forced/dev.txt"
export TEST_FILE="${JAMR_HOME}/data/LDC2016E25/data/amrs/split/test/jamr_forced/test.txt"

export MODEL_DIR="${JAMR_HOME}/models/jamr/E25_jamr_forced"  # ideally keep this the same as the config_SOMETHING.sh
